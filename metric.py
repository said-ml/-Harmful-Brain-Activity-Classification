...
if __name__=='__main__':
    ...
    score1=score(pd.DataFrame({'id': range(4), 'ham': [0, 1, 1, 0], 'spam': [1, 0, 0, 1]}),
               pd.DataFrame({'id': range(4), 'ham': [.1, .9, .8, .35], 'spam': [.9, .1, .2, .65]}),
    ...
    submission = pd.DataFrame(
        {'id': range(3), 'ham': [0, 0.5, 0.5], 'spam': [0.1, 0.5, 0.5], 'other': [0.9, 0, 0]})
    score2=score(solution, submission, 'id')
    ...
    solution = pd.DataFrame({'id': range(3), 'ham': [0, 0.5, 0.5], 'spam': [0.1, 0.5, 0.5], 'other': [0.9, 0, 0]})
    submission = pd.DataFrame(
        {'id': range(3), 'ham': [0.2, 0.3, 0.5], 'spam': [0.1, 0.5, 0.5], 'other': [0.7, 0.2, 0]})
    score3=score(solution, submission, 'id')

    print('score3=', score3)
    # 0.1605319324452703

    #score1 = 0.21616187468057918
    #score2 = 0.0
    #score3 = 0.1605319324452703